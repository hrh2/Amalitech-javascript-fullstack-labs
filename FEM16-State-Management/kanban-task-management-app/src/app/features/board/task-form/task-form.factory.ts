...
export function applyDuplicateTitleValidator(form: FormGroup, existingTitles: string[]): void {
  const titleControl = form.get('title')!;
  titleControl.addValidators(duplicateTitleValidator(existingTitles));
