...
export function populateMoodSelect(select) {
    select.innerHTML = "";
...
export function populateMoodFilter(select) {
    select.innerHTML = "";
...
function createEntryElement(entry) {
    ...
    page.setAttribute("aria-label", `${entry.title}. Mood: ${meta.label}. ${formatTimestamp(entry.timestamp)}.`);
    page.innerHTML = `
  ...
  `;
    ...
    const titleEl = page.querySelector(".entry__title");
    const contentEl = page.querySelector(".entry__content");
    if (titleEl)
    ...
    const editBtn = page.querySelector(".entry__edit");
    const deleteBtn = page.querySelector(".entry__delete");
    if (editBtn)
